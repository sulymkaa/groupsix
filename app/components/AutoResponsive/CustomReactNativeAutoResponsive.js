...
class CustomReactNativeAutoResponsive extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  getItemMarginVertical() {
    if (!!this.props.itemMargin) {
      ...
      return this.props.itemMargin.vertical || 0;
    }
    return 0;
  }
  ...
  renderChildren() {
    return React.Children.map(this.props.children, function(child, childIndex) {
      ...
      let childWidth = parseInt(childStyle.width) + this.getItemMarginHorizontal() / 2;
      let childHeight = parseInt(childStyle.height) + this.getItemMarginVertical();
      ...
      if (calculatedStyle.left > 0) {
        calculatedStyle.left += this.getItemMarginHorizontal()/2;
      }
...
CustomReactNativeAutoResponsive.defaultProps = {
...
module.exports = CustomReactNativeAutoResponsive;
